...
- Choose a story (sample or newly generated)
- **Reader layout** (Settings → Reader Layout):
  - **Classic**: One image at top, full story; click "Play English" or "Play Translation"; sentences highlight in sync. Use Pause/Reset and speed controls.
  - **Step-by-step**: One sentence + one image at a time (no scrolling). Choose "Listen in English" or "Listen in [Hindi]" for bilingual; use **Back** / **Play** / **Next** (audio auto-plays when you click Next). "Play translation" plays the current sentence in the other language.
- Per-sentence images are generated when the story is created, so step-by-step playback is smooth.
...
- **Dynamic Images**: Cover image (DALL-E 3) + per-sentence images (DALL-E 2) in step-by-step mode; same story characters and style across images
- **Smooth animations** throughout
- **Large, friendly buttons** perfect for kids
- **Two reader layouts**: Classic (full story) and Step-by-step (one sentence at a time, kid-paced)
...
- **Bilingual highlight**: "Play Translation" highlights the translated (e.g. Hindi) text, not English.
- **Reader layouts**: Settings → Reader Layout — **Classic** or **Step-by-step** (one sentence + image, Back/Next, language choice for bilingual).
- **Step-by-step**: Back button; auto-play on Next/Back; "Listen in English" / "Listen in Hindi" at start; "Play translation" for current sentence.
- **Per-sentence images**: Generated at story creation; DALL-E 2 with story context so characters stay consistent.
...
**Changelog**: See README.md and PROJECT_SUMMARY.md for full list of recent changes (reader layouts, step-by-step mode, bilingual highlight, per-sentence images).
